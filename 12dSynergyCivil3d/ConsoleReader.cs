...
namespace ScriptTest
{
    ...
    public abstract class ConsoleReaderBase : IConsoleReader
    {
    ...
    public class ConsoleReader : ConsoleReaderBase, IConsoleReader
    {
        public ConsoleReader(StreamReader standardOutput)
        {
